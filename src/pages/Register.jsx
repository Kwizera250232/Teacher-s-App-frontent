        ...
        {pending ? (
          <>
            ...
            <p className="auth-sub" style={{ marginTop: 12, lineHeight: 1.6 }}>
              Konti yawe y'umwarimu yoherejwe. <strong>Tegereza ko umuyobozi ayemera</strong> mbere yo
              kwinjira mu rubuga. Uzabona imeyili iyo uruhushya ruguye.
            </p>
            {schoolCode && (
                    ...
                    <div className="register-school-grid">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setForm({ ...form, school_name: e.target.value, school_id: '' })
                          }
