...
const TABS = ['Announcements', 'Activities', 'Notes', 'Homework', 'Quizzes', 'Leaderboard', 'Discussion', 'Classmates'];
...
export default function StudentClassPage() {
  ...
  const loadTab = async () => {
    setError('');
    if (tab === 'Leaderboard' || tab === 'Activities') return;
    if (tab === 'Classmates') {
      try {
  ...
  return (
    <div className="class-page wa-theme">
      ...
      <main className="class-main wa-chat-screen">
        ...
        {tab === 'Activities' && <ClassroomFeed classId={id} token={token} />}
