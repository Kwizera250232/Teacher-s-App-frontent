    ...
    >
      <div style={{
        ...
        <div style={{
          ...
          {person.email && <div style={{ fontSize: 13, color: '#64748b', marginTop: 6 }}>âœ‰ï¸ {person.email}</div>}
        </div>
        ...
        <div style={{ padding: '0 20px 4px' }}>
          ...
          {(person.dreams || favLessons.length > 0 || hobbies.length > 0 || person.fears) && (
            <div style={{ padding: '16px 0', borderBottom: '1px solid #f1f5f9' }}>
              ...
              {person.fears && (
                <div style={{ marginBottom: 10 }}>
                  <div style={{ fontSize: 12, fontWeight: 700, color: '#64748b', marginBottom: 4 }}>ðŸ˜° What I Fear</div>
        ...
        {/* Footer */}
        <div style={{ display: 'flex', gap: 10, padding: '16px 20px 32px', borderTop: '1px solid #f1f5f9' }}>
          {onMessage && (
