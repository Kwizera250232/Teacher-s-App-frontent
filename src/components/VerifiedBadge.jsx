...
export default function VerifiedBadge({ size = 16, info = null, onViewProfile = null }) {
  ...
  if (!info) {
    return (
      <span style={{ display: 'inline-flex', alignItems: 'center', marginLeft: 8, flexShrink: 0, verticalAlign: 'middle' }}>
        <BadgeSvg sz={size} />
      </span>
    );
  }
  ...
  return (
    ...
    >
      <span
        style={{ display: 'inline-flex', alignItems: 'center', marginLeft: 8, cursor: 'pointer' }}
