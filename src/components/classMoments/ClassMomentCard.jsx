...
import { momentImageUrl, teacherAvatarUrl, formatMomentWhen } from '../../utils/momentImages';
...
export default function ClassMomentCard({ moment, style }) {
  ...
  return (
    <article className="cm-card" style={style}>
      ...
      {current && (
        ...
        >
          <img src={momentImageUrl(current.file_path)} alt="" loading="lazy" />
          {images.length > 1 && (
